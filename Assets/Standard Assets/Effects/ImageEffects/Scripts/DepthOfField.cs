...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class DepthOfField : PostEffectsBase {
        ...
        void CreateComputeResources () {
            if (cbDrawArgs == null)
            {
                cbDrawArgs = new ComputeBuffer (1, 16, ComputeBufferType.IndirectArguments); //Asema: I dont know what was this IndirectArguments, but was getting error so replaced it with DrawIndirect.
                var args= new int[4];
