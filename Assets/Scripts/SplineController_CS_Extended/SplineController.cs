...
public class SplineController : MonoBehaviour
{
	...
	void Start ()
	{
		...
		Debug.Log (this.transform.gameObject.name + " = Num spline nodes: " + mSplineNodeInfo.Length);
	...
	public void FollowSpline ()
	{
		if (mSplineNodeInfo.Length > 0) {
			...
			mSplineInterp.CurrentTime = TimeOffset;
		}
	}
	...
	/// </summary>
	public SplineNode[] GetSplineNodes ()
	{
		if (SplineRoot == null)
			return null;
